...
//Ans:-
let obj1 = { name: "Happy", class: "X", rollno: "37" };
let obj2 = { name: "Ayush", class: "XI", rollno: "40" };
let obj3 = { name: "Utkarsh", class: "XII", rollno: "45" };
let obj4 = { name: "Kishan", class: "XI", rollno: "48" };
let obj5 = { name: "Aman", class: "X", rollno: "07" };
let obj6 = { name: "Gopal", class: "XII", rollno: "18" };

let students = [
  { name: "Happy", class: "X", rollno: "37" },
  { name: "Ayush", class: "XI", rollno: "40" },
  { name: "Utkarsh", class: "XII", rollno: "45" },
  { name: "Kishan", class: "XI", rollno: "48" },
  { name: "Aman", class: "X", rollno: "07" },
  { name: "Gopal", class: "XII", rollno: "18" },
];
